...
live — switching re-uploads nothing. `npx driggsby@latest delete` removes
a deployed app forever, after asking you to type its address name back
(`--yes` for scripts). `npx driggsby@latest query <tool>`
